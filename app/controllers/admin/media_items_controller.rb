class Admin::MediaItemsController < Admin::ForestController
  ...
  def media_item_params
    params.require(:media_item).permit(:title, :slug, :caption, :alternative_text, :description, :attachment, :selected, :point_of_interest_x, :point_of_interest_y, :retain_source, *MediaItem.localized_params, *MediaItem.additional_permitted_params)
  end
